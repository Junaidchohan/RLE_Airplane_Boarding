...
# Placed at the BOTTOM of the file to avoid circular import issues:
# If register() is at the top, Gymnasium may try to import this module (airplane_boarding)
# before all classes are defined, resulting in an empty module cache.
